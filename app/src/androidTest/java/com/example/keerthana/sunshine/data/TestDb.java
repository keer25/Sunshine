 ...
 */
package com.example.keerthana.sunshine.data;
...
public class TestDb extends AndroidTestCase {
    ...
    void deleteTheDatabase() {
        mContext.deleteDatabase(com.example.keerthana.sunshine.data.WeatherDbHelper.DATABASE_NAME);
    }
    ...
    */
    public long testLocationTable() {
        ...
        assertTrue("Unable to insert into database", locationRowID!= -1);
    ...
    public void testWeatherTable() {
        ...
        long locationKey = TestUtilities.insertNorthPoleLocationValues(this.mContext);
        ...
        assertTrue("Weather data not entered", weatherRowID != -1);
        // Query the database and receive a Cursor back
        Cursor c = db.query(WeatherContract.WeatherEntry.TABLE_NAME,
                ...
                null);
        // Move the cursor to a valid database row
        assertTrue("No Weater Results were identified", c.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Weather Records do not match", c, values);
        c.close();
        db.close();
        // Finally, close the cursor and database
    }
